...
def main():
    ...
    process_data(cur, conn, filepath='../../data/external/data/song_data', func=process_song_file)
    process_data(cur, conn, filepath='../../data/external/data/log_data', func=process_log_file)
